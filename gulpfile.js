...
(function () {
	...
	gulp.task("settings-js", function () {
		gulp.src([
			"src/admin/js/movie-review-admin.js"
		])
			.pipe(jshint())
			.pipe(jshint.reporter("jshint-stylish"))
			.pipe(jshint.reporter("fail"))
			.pipe(concat("movie-review-settings.js"))
			.pipe(sourcemaps.init())
			.pipe(uglify())
			.pipe(sourcemaps.write())
			.pipe(rename({ suffix: ".min" }))
	...
	gulp.task("meta-box-js", function () {
		gulp.src("src/admin/js/movie-review-meta-box.js")
			.pipe(jshint())
			.pipe(jshint.reporter("jshint-stylish"))
			.pipe(jshint.reporter("fail"))
			.pipe(concat("movie-review-meta-box.js"))
			.pipe(sourcemaps.init())
			.pipe(uglify())
			.pipe(sourcemaps.write())
			.pipe(rename({ suffix: ".min" }))
	...
	gulp.task("build", function (cb) {
		runSequence("clean", ["sass", "js", "php", "images", "languages"], cb);
	});
